...
object BridgeCommandTypes {
    ...
    const val DOWNLOAD_FILE_PROGRESS = "DOWNLOAD_FILE_PROGRESS"
    const val DOWNLOAD_FILE_BEGIN = "DOWNLOAD_FILE_BEGIN"
    const val DOWNLOAD_FILE_CHUNK = "DOWNLOAD_FILE_CHUNK"
    const val DOWNLOAD_FILE_END = "DOWNLOAD_FILE_END"
    const val DOWNLOAD_FILE_CANCEL = "DOWNLOAD_FILE_CANCEL"
    ...
    const val SYNC_SESSION_STATE = "SYNC_SESSION_STATE"
    const val SESSION_IMPORT_RESULT = "SESSION_IMPORT_RESULT"
    const val WEB_UI_READY = "WEB_UI_READY"
}
